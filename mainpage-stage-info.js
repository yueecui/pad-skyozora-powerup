...
(function() {
    ...
    const stage_drop_map = {
        ...
        'ゼレンバス降臨！': [
            {n:'蠱惑之捕棘龍・瑟年巴斯', i:'6342', t:''},
            {n:'蔓蛇劍・秘泥迪斯', i:'6343', t:''},
            {n:'蠱惑之捕棘龍・瑟年巴斯的希石', i:'6344', t:''},
        ],
        'グリモワール降臨！': [
            {n:'紅輪之魔導姬・迪魯奇亞', i:'1750', t:''},
            {n:'蒼刻之魔導姬・阿魯絲＝寶琳娜', i:'1752', t:''},
            {n:'碧精之魔導姬・阿魯瑪迪爾', i:'1754', t:''},
        ],        
        'ゼローグ∞降臨！': [
            {n:'黑天之幻龍王・塞洛古∞的希石', i:'4557', t:''},
        ],
        'かぐや姫降臨！': [
            {n:'木之希石【大】', i:'4465', t:'需进化'},
            {n:'翠光之月天花・輝夜姬的希石', i:'4517', t:''},
        ],
        'マンティコア降臨！': [
            {n:'灼林的魔獄獸・蠍獅的希石', i:'4485', t:''},
        ],
        'センリ降臨！': [
            {n:'神門之狛犬姬・千里的希石', i:'5547', t:''},
        ],
        'ラグウェル降臨！': [
            {n:'綠冥龍・拉庫威爾', i:'2941', t:''},
        ],
        'リベルタス降臨！': [
            {n:'星燈之自由神・自主神', i:'5057', t:''},
        ],
        'サンタクロース降臨！': [
            {n:'光之希石【大】', i:'4466', t:'需进化'},
        ],
        'チィリン降臨！': [
            {n:'避邪之武身・琪玲的希石', i:'5122', t:''},
        ],
        'スタージャスティス降臨！': [
            {n:'鐵機帝・另一正義使者', i:'2989', t:''},
            {n:'鐵機王・正義之星的希石', i:'4515', t:''},
        ...
        'エルメ降臨！': [
            {n:'耀眼的骸龍契士・艾爾薇＝杜', i:'3739', t:''},
            {n:'烈眼的骸龍契士・艾爾薇＝拉', i:'3738', t:''},
            {n:'靜眼的骸龍契士・艾爾薇＝固', i:'3740', t:''},
        ],
        'スフィンクス降臨！': [
            {n:'火之希石【大】', i:'4463', t:'需进化'},
        ...
        'ゼウス・ヴァルカン降臨！': [
            {n:'火之希石【中】', i:'4458', t:'需进化'},
            {n:'超覺醒宙斯・伏爾坎的希石', i:'4468', t:'需进化'},

        ],
        'ドット・ヴァルキリー降臨！': [
            {n:'點陣圖・火山龍的希石', i:'6254', t:''},
            {n:'點陣圖・女武神・瓦爾基麗公主的希石', i:'6228', t:''},
        ],
        '協力！リントヴルム降臨！': [
            {n:'冥爪之海蛇龍・林德蟲的希石', i:'5073', t:''},
        ],
        'ゼウス＝ドラゴン降臨！': [
            {n:'全能神・宙斯龍的希石', i:'4535', t:''},
        ],
